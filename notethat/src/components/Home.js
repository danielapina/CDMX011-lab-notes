  ...
  return (
    <div className="container-home">
      <header className="header-home">
        ...
        <Link to="/register">
          <button className="btn-heading-signup"> Sign Up</button>
        </Link>
        <Link to="/login">
          <button className="btn-heading-login"> Log In</button>
        </Link>
      </header>
      <div className="home-title">
        <h1 className="title-home">
          Don’t loose <span className="that-span">that</span> great idea.
        </h1>
        <p className="slogan-home">Create a space of your own</p>
        <Link to="/register">
          <button className="btn-signup">Sign up now for free</button>
        </Link>
      </div>
      <div className="home-content">
        ...
        <div className="that-idea-content">
          ...
          <div className="bye-paper-div">
            ...
            <p>Help the enviroment by using less paper and use Note That!</p>
          </div>
        </div>
      </div>
